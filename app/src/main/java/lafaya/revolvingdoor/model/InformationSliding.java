...
public class InformationSliding {
...
//    // =============================================================================================
//    // 仅可读参数
//    public void initializeInfoSliding(Activity inactivity){
//        //仅可读参数
//        grid_infoSliding = inactivity.findViewById(R.id.grid_infoSilding);
//        // 参数初始化
//        DataBase.instance().mapInfoSliding = ParameterUpdate.instance().paraInfoUpdate(DataBase.instance().mapInfoSliding,null,0);
//
//        //gird 监听
//        grid_infoSliding.setOnItemClickListener(new AdapterView.OnItemClickListener() {
//            @Override
...
//
//    //查询操作，当展开菜单时，查询参数。
//    public boolean checkInfoSliding(){
//        // 按菜单从上到下查询参数
//
...
//    }
//
//    public void updateGrideInfoSliding(Activity activity){
//        List<HashMap<String, Object>> list;
//
//        // 参数显示写入：按上到下顺序写入其它、速度、位置、电流、PWM参数
//
//        list = ParameterUpdate.instance().listInfoNormal(DataBase.instance().mapInfoSliding);
//
//        //写入grid view
...
//        grid_infoSliding.setAdapter(saImageItems);
//    }
