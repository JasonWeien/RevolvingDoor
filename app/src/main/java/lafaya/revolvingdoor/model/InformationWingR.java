...
public class InformationWingR {
    private Activity activity;
    private AutoCountListView grid_infoWingR;
...
//    public int posInfoSelected = 0;
    ...
    // 仅可读参数
//    public void initializeInfoWingR(Activity inactivity){
//        //仅可读参数
//        grid_infoWingR = inactivity.findViewById(R.id.grid_infoWingR);
//        // 参数初始化
//        DataBase.instance().mapInfoWingR = ParameterUpdate.instance().paraInfoUpdate(DataBase.instance().mapInfoWingR,null,0);
//
//        //gird 监听
//        grid_infoWingR.setOnItemClickListener(new AdapterView.OnItemClickListener() {
//            @Override
...
//            }
//        });
//        updateGrideInfoWingR(inactivity);
//    }
//
//    //查询操作，当展开菜单时，查询参数。
//    public boolean checkInfoWingR(){
//        // 按菜单从上到下查询参数
//
...
//    }
//
//    public void updateGrideInfoWingR(Activity activity){
//        List<HashMap<String, Object>> list;
//
//        // 参数显示写入：按上到下顺序写入其它、速度、位置、电流、PWM参数
//
//        list = ParameterUpdate.instance().listInfoNormal(DataBase.instance().mapInfoWingR);
//
//        //写入grid view
...
//        grid_infoWingR.setAdapter(saImageItems);
//    }
}
